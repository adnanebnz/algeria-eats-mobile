...
class _ArtisanProfileScreenState extends State<ArtisanProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
          child: Container(
        padding: const EdgeInsets.only(bottom: 12, top: 5, left: 16, right: 16),
        child: ListView(
          children: [
            Column(children: [
              Container(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  buildDataRow('Prénom', widget.artisan.user.prenom, context),
                  buildDataRow('Adresse', widget.artisan.user.adresse, context),
                  buildDataRow('Wilaya', widget.artisan.user.wilaya, context),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              title: Text(
                                artisanController.artisanProducts[index].nom,
                              ),
                              subtitle: RatingView(
